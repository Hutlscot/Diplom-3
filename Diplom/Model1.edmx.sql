...
-- --------------------------------------------------
-- Date Created: 03/26/2021 22:14:28
-- Generated from EDMX file: D:\Diplom\Diplom\Model.edmx
-- --------------------------------------------------

SET QUOTED_IDENTIFIER OFF;
GO
USE [D:\DIPLOM\DIPLOM\DATABASE.MDF];
GO
...
GO
IF OBJECT_ID(N'[dbo].[FK_ResponsiblePersons_Workers]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ResponsiblePersons] DROP CONSTRAINT [FK_ResponsiblePersons_Workers];
GO
IF OBJECT_ID(N'[dbo].[FK_ResponsiblePersons_Cabinets]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ResponsiblePersons] DROP CONSTRAINT [FK_ResponsiblePersons_Cabinets];
GO
